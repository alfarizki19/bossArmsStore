// Summary visibility controller for Ejection Port Cover

function getQuantityById_EPC(variantId) {
...
export function resetSummary_EjectionPortCover() {
    const ids = [
        "ejectionPortCover00100101",
        "ejectionPortCover00100102",
        "ejectionPortCover00100103",
        "ejectionPortCover00100104",
        "ejectionPortCover00100105",
        "ejectionPortCover00100106",
        "ejectionPortCover00100107",
        "ejectionPortCover00100108",
        "ejectionPortCover00100109",
        "ejectionPortCover00100110"
    ];
    ids.forEach(id => {
...
export function updateSummary_EjectionPortCover() {
    const ids = [
        "ejectionPortCover00100101",
        "ejectionPortCover00100102",
        "ejectionPortCover00100103",
    ...
    ids.forEach(id => {
        const qty = getQuantityById_EPC(id);
        if (qty > 0) {
            const el = document.getElementById(`summaryItems_${id}`);
            if (el) el.style.display = "";

            const meta = getTitleAndPriceById_EPC(id);
