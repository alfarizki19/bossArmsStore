// Summary controller for Optic Sight (Gear)
...
export function resetSummary_OpticSight() {
    try { document.querySelectorAll('[id^="summaryItems_opticSight"]').forEach(el => { el.style.display = "none"; }); } catch (_) {}
}

export function updateSummary_OpticSight() {
...
window.resetSummary_OpticSight = resetSummary_OpticSight;
