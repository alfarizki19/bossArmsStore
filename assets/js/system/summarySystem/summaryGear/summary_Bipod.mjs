// Summary controller for Bipod (Gear)
...
export function resetSummary_Bipod() {
    try { document.querySelectorAll('[id^="summaryItems_bipod"]').forEach(el => { el.style.display = "none"; }); } catch (_) {}
}

export function updateSummary_Bipod() {
...
window.resetSummary_Bipod = resetSummary_Bipod;
