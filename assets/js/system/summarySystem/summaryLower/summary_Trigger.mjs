// Summary controller for Trigger (Lower)
...
export function resetSummary_Trigger() {
    try { document.querySelectorAll('[id^="summaryItems_trigger"]').forEach(el => { el.style.display = "none"; }); } catch (_) {}
}

export function updateSummary_Trigger() {
