// Summary controller for Trigger Guard (Lower)
...
export function resetSummary_TriggerGuard() {
    try { document.querySelectorAll('[id^="summaryItems_triggerGuard"]').forEach(el => { el.style.display = "none"; }); } catch (_) {}
}

export function updateSummary_TriggerGuard() {
