// Summary controller for Magazine (Lower)
...
export function resetSummary_Magazine() {
    try { document.querySelectorAll('[id^="summaryItems_magazine"]').forEach(el => { el.style.display = "none"; }); } catch (_) {}
}

export function updateSummary_Magazine() {
...
window.resetSummary_Magazine = resetSummary_Magazine;
window.updateSummary_Magazine = updateSummary_Magazine;
