// Summary controller for End Plate (Lower)
...
export function resetSummary_EndPlate() {
    try { document.querySelectorAll('[id^="summaryItems_endPlate"]').forEach(el => { el.style.display = "none"; }); } catch (_) {}
}

export function updateSummary_EndPlate() {
