// Summary controller for Safety (Lower)
...
export function resetSummary_Safety() {
    try { document.querySelectorAll('[id^="summaryItems_safety"]').forEach(el => { el.style.display = "none"; }); } catch (_) {}
}

export function updateSummary_Safety() {
