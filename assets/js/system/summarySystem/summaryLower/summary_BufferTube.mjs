// Summary controller for Buffer Tube (Lower)
...
export function resetSummary_BufferTube() {
    try { document.querySelectorAll('[id^="summaryItems_bufferTube"]').forEach(el => { el.style.display = "none"; }); } catch (_) {}
}

export function updateSummary_BufferTube() {
