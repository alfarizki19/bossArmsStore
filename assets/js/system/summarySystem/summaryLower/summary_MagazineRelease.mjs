// Summary controller for Magazine Release (Lower)
...
export function resetSummary_MagazineRelease() {
    try { document.querySelectorAll('[id^="summaryItems_magazineRelease"]').forEach(el => { el.style.display = "none"; }); } catch (_) {}
}

export function updateSummary_MagazineRelease() {
